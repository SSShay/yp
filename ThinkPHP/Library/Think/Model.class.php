...
class Model {
     ...
     * @return bool
     */
    public function addObj($data, $type = '')
    {
     ...
     * @return mixed
     */
    public function findObj($where,$field = "*")
    {
        if (isset($where) && !empty($where)) {
            $obj = $this->field($field)->where($where)->find();
            return $obj;
        }
        $this->error = '条件不能为空';
        return null;
     ...
     * @return mixed
     */
    public function selectObj($where,$field = "*",$order = '')
    {
        if (isset($where) && !empty($where)) {
            $obj = $this->field($field)->where($where)->order($order)->select();
            return $obj;
        }
        $this->error = '条件不能为空';
        return null;
     ...
     * @return mixed
     */
    public function setObj($where,$data)
    {
        if (isset($where) && !empty($where)) {
     ...
     * @return mixed
     */
    public function deleteObj($where)
    {
        if (isset($where) && !empty($where)) {
            $obj = $this->where($where)->delete();
            return !!$obj;
        }
        $this->error = '条件不能为空';
        return false;
